...
import (
	...
	"github.com/azzamjiul/bookstore_oauth-api/src/utils/crypto_utils"
...
func (at *AccessTokenRequest) Validate() *error_utils.RestErr {
	switch at.GrantType {
	...
	case grantTypeClientCredentials:
		break
	default:
		return error_utils.NewBadRequestError("invalid grant type parameter")
	}
...
func (at *AccessToken) Validate() *error_utils.RestErr {
